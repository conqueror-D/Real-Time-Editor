...
export default function JoinRoom() {
    ...
    function handleRoomSubmit(e) {
        ...
        username && navigate(`/room/${roomId}`, { state: { username, roomIdToCreatorName, roomIdToRoomName } });
    }
    ...
    const handleCreateRoom = (roomName, creatorName, userName) => {
        try {
            ...
            setRoomIdToCreatorName(prevMap => new Map(prevMap).set(id, creatorName));
    ...
    return (
        <div className="joinBoxWrapper">
            {joinRoom && <form className="joinBox" onSubmit={handleRoomSubmit}>
